#!/system/bin/sh
DIR=/data/data/com.github.ananbox/files
...
export PATH=/sbin:/system/bin:/system/sbin:/system/xbin 
...
$1 --kill-on-exit -v 255 -r $DIR/rootfs -0 -w / -b /dev -b /proc -b /sys -b $DIR/rootfs/dev/kmsg:/dev/kmsg -b $DIR/rootfs/system/vendor:/vendor -b $DIR/rootfs/dev/__properties__:/dev/__properties__ -b $DIR/rootfs/dev/socket:/dev/socket -b /dev/binder:/dev/binder -b /dev/ashmem:/dev/ashmem -b $DIR/qemu_pipe:/dev/qemu_pipe -b $DIR/rootfs/dev/input:/dev/input -b $DIR/rootfs/mnt/user/0:/storage/self /init > $DIR/proot.log 2>&1 &
